...
_STAGE3_VJEPA_DEFAULT = STAGE3_MODEL / "vitl16.pth.tar"
if not _STAGE3_VJEPA_DEFAULT.is_file() and (STAGE3_MODEL / "vitl16.pth").is_file():
    _STAGE3_VJEPA_DEFAULT = STAGE3_MODEL / "vitl16.pth"
STAGE3_VJEPA_CHECKPOINT = _path_env("STAGE3_VJEPA_CHECKPOINT", _STAGE3_VJEPA_DEFAULT)
# ============================================================
# Data directories
# ============================================================
...
STAGE3_BATCH_SIZE = int(os.getenv("STAGE3_BATCH_SIZE", "4"))
STAGE3_VJEPA_EPOCHS = int(os.getenv("STAGE3_VJEPA_EPOCHS", "8"))
STAGE3_USE_BF16 = _bool_env("STAGE3_USE_BF16", True)
STAGE3_VJEPA_RESUME = _bool_env("STAGE3_VJEPA_RESUME", True)
...
STAGE3_VJEPA_INPUT_FRAMES = int(os.getenv("STAGE3_VJEPA_INPUT_FRAMES", "8"))
if STAGE3_VJEPA_INPUT_FRAMES not in {8, 16}:
    raise ValueError("STAGE3_VJEPA_INPUT_FRAMES must be 8 or 16")
STAGE3_VJEPA_FRAME_POSITIONS = (
    tuple(range(STAGE3_NUM_FRAMES))
    if STAGE3_VJEPA_INPUT_FRAMES == 16
    else (0, 2, 4, 6, 8, 10, 12, 15)
)
...
STAGE3_NUM_WORKERS = int(os.getenv("STAGE3_NUM_WORKERS", "4"))
STAGE3_PREFETCH_FACTOR = int(os.getenv("STAGE3_PREFETCH_FACTOR", "2"))

...
STAGE3_ARCH = os.getenv("STAGE3_ARCH", "mvit_v2_s")
...
STAGE3_VJEPA_REPO = Path(os.getenv("STAGE3_VJEPA_REPO", str(PROJECT_ROOT / "external" / "vjepa2")))
STAGE3_VJEPA_CHECKPOINT = Path(os.getenv("STAGE3_VJEPA_CHECKPOINT", str(STAGE3_MODEL / "vjepa2_1_vitb_dist_vitG_384.pt")))
STAGE3_VJEPA_BACKBONE_NAME = "vjepa2_1_vit_base_384"
STAGE3_VJEPA_PROBE = os.getenv("STAGE3_VJEPA_PROBE", "mean")
STAGE3_VJEPA_INPUT_SIZE = int(os.getenv("STAGE3_VJEPA_INPUT_SIZE", "224"))
STAGE3_VJEPA_FREEZE_BACKBONE = True
STAGE3_VJEPA_PROBE_DIM = 384
STAGE3_VJEPA_PROBE_HEADS = 6
STAGE3_VJEPA_DROPOUT = 0.2
STAGE3_VJEPA_PROBE_LR = 1e-4
STAGE3_VJEPA_WEIGHT_DECAY = 0.05
STAGE3_VJEPA_EARLY_STOPPING_PATIENCE = 2
STAGE3_TARTANVO_FEATURE = "latent"
STAGE3_TARTANVO_MODE = "finetune"
STAGE3_TARTANVO_UNFREEZE = "full"
...
STAGE3_SEGMENT_FEATURE_LRU_SIZE = 32
